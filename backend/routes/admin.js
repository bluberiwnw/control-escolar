...
router.get('/asistencias/exportar', adminController.exportarAsistenciasCSV);
router.get('/asistencias/exportar/excel', adminController.exportarAsistenciasExcel);
router.get('/asistencias/exportar/pdf', adminController.exportarAsistenciasPDF);
router.get('/asistencias/reporte/curso/:materia_id', adminController.reporteAsistenciaPorCurso);
